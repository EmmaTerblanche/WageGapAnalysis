...
```{r}
mincer3 <- lm(logsal ~ Race + prispline + secspline + terspline + exp + expsq + Gender + lastyear + Race*Y2009 + Race*Y2016, data = appendedGHS)

m_list <- list(WithoutExperience = mincer2, WithExperience = mincer3)
